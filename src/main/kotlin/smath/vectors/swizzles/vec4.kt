...
val Vec4.xxx get() = Vec3Ext.new(x, x, x)
val Vec4.xxy get() = Vec3Ext.new(x, x, y)
val Vec4.xxz get() = Vec3Ext.new(x, x, z)
val Vec4.xxw get() = Vec3Ext.new(x, x, w)
val Vec4.xyx get() = Vec3Ext.new(x, y, x)
val Vec4.xyy get() = Vec3Ext.new(x, y, y)
val Vec4.xyz get() = Vec3Ext.new(x, y, z)
val Vec4.xyw get() = Vec3Ext.new(x, y, w)
val Vec4.xzx get() = Vec3Ext.new(x, z, x)
val Vec4.xzy get() = Vec3Ext.new(x, z, y)
val Vec4.xzz get() = Vec3Ext.new(x, z, z)
val Vec4.xzw get() = Vec3Ext.new(x, z, w)
val Vec4.xwx get() = Vec3Ext.new(x, w, x)
val Vec4.xwy get() = Vec3Ext.new(x, w, y)
val Vec4.xwz get() = Vec3Ext.new(x, w, z)
val Vec4.xww get() = Vec3Ext.new(x, w, w)
val Vec4.yxx get() = Vec3Ext.new(y, x, x)
val Vec4.yxy get() = Vec3Ext.new(y, x, y)
val Vec4.yxz get() = Vec3Ext.new(y, x, z)
val Vec4.yxw get() = Vec3Ext.new(y, x, w)
val Vec4.yyx get() = Vec3Ext.new(y, y, x)
val Vec4.yyy get() = Vec3Ext.new(y, y, y)
val Vec4.yyz get() = Vec3Ext.new(y, y, z)
val Vec4.yyw get() = Vec3Ext.new(y, y, w)
val Vec4.yzx get() = Vec3Ext.new(y, z, x)
val Vec4.yzy get() = Vec3Ext.new(y, z, y)
val Vec4.yzz get() = Vec3Ext.new(y, z, z)
val Vec4.yzw get() = Vec3Ext.new(y, z, w)
val Vec4.ywx get() = Vec3Ext.new(y, w, x)
val Vec4.ywy get() = Vec3Ext.new(y, w, y)
val Vec4.ywz get() = Vec3Ext.new(y, w, z)
val Vec4.yww get() = Vec3Ext.new(y, w, w)
val Vec4.zxx get() = Vec3Ext.new(z, x, x)
val Vec4.zxy get() = Vec3Ext.new(z, x, y)
val Vec4.zxz get() = Vec3Ext.new(z, x, z)
val Vec4.zxw get() = Vec3Ext.new(z, x, w)
val Vec4.zyx get() = Vec3Ext.new(z, y, x)
val Vec4.zyy get() = Vec3Ext.new(z, y, y)
val Vec4.zyz get() = Vec3Ext.new(z, y, z)
val Vec4.zyw get() = Vec3Ext.new(z, y, w)
val Vec4.zzx get() = Vec3Ext.new(z, z, x)
val Vec4.zzy get() = Vec3Ext.new(z, z, y)
val Vec4.zzz get() = Vec3Ext.new(z, z, z)
val Vec4.zzw get() = Vec3Ext.new(z, z, w)
val Vec4.zwx get() = Vec3Ext.new(z, w, x)
val Vec4.zwy get() = Vec3Ext.new(z, w, y)
val Vec4.zwz get() = Vec3Ext.new(z, w, z)
val Vec4.zww get() = Vec3Ext.new(z, w, w)
val Vec4.wxx get() = Vec3Ext.new(w, x, x)
val Vec4.wxy get() = Vec3Ext.new(w, x, y)
val Vec4.wxz get() = Vec3Ext.new(w, x, z)
val Vec4.wxw get() = Vec3Ext.new(w, x, w)
val Vec4.wyx get() = Vec3Ext.new(w, y, x)
val Vec4.wyy get() = Vec3Ext.new(w, y, y)
val Vec4.wyz get() = Vec3Ext.new(w, y, z)
val Vec4.wyw get() = Vec3Ext.new(w, y, w)
val Vec4.wzx get() = Vec3Ext.new(w, z, x)
val Vec4.wzy get() = Vec3Ext.new(w, z, y)
val Vec4.wzz get() = Vec3Ext.new(w, z, z)
val Vec4.wzw get() = Vec3Ext.new(w, z, w)
val Vec4.wwx get() = Vec3Ext.new(w, w, x)
val Vec4.wwy get() = Vec3Ext.new(w, w, y)
val Vec4.wwz get() = Vec3Ext.new(w, w, z)
val Vec4.www get() = Vec3Ext.new(w, w, w)
